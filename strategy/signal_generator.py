...
# Import conviction scorer - must use absolute import when running as script
# Relative imports don't work with `python strategy/signal_generator.py`
import os
...
if __name__ == "__main__":
    ...
    if signal:
        ...
        print("\n[FAIL] NO SIGNAL (conviction too low)")
